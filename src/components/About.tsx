      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="animate-on-scroll opacity-0 transition-all duration-700 delay-300">
            <h3 className="text-2xl font-semibold mb-4 text-white">Education & Experience</h3>
            <div className="space-y-4">
              <div className="border-l-2 border-blue-400 pl-4">
                <p className="text-sm text-blue-400 font-medium">2025 - Present</p>
                <h4 className="text-lg font-medium text-white">Site Reliability Engineer</h4>
                <p className="text-gray-300">Yum Brands! (Contractor)</p>
              </div>
              <div className="border-l-2 border-blue-400 pl-4">
                <p className="text-sm text-blue-400 font-medium">09/2022 - 04/2025</p>
                <h4 className="text-lg font-medium text-white">Senior Systems Engineer</h4>
                <p className="text-gray-300">EPAM Systems</p>
              </div>
              <div className="border-l-2 border-blue-400 pl-4">
                <p className="text-sm text-blue-400 font-medium">07/2021 - 09/2022</p>
                <h4 className="text-lg font-medium text-white">DevOps Engineer</h4>
                <p className="text-gray-300">Globant</p>
              </div>
              <div className="border-l-2 border-blue-400 pl-4">
                <p className="text-sm text-blue-400 font-medium">01/2019 - 07/2021</p>
                <h4 className="text-lg font-medium text-white">DevOps Engineer</h4>
                <p className="text-gray-300">BTG Pactual S.A</p>
              </div>
              <div className="border-l-2 border-blue-400 pl-4">
                <p className="text-sm text-blue-400 font-medium">01/2015 - 11/2019</p>
                <h4 className="text-lg font-medium text-white">Computer Science Degree</h4>
                <p className="text-gray-300">EAFIT University</p>
              </div>
            </div>
          </div>
        </div>
